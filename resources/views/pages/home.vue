...
import { GlobalTheme, NElement } from 'naive-ui';
    ...
    <normal-layout>
        ...
        <div
            ...
            :style="`background-image: url('/images/${
                theme?.name == 'dark' ? 'hero-bg-dark' : 'hero-bg-light'
            }.svg');
            ...
            <div class="w-8/12 p-10">
                <div class="mt-20 p-5">
                    <h1
                        class="font-bold text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
                        Solusi Terbaik
                    </h1>
                    <n-element
                        class="font-bold text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[var(--success-color)]">
                        Untuk Mengelola Keuanganmu
                    </n-element>
                    <p class="mt-8 xl:text-lg">
                        Koperasi Maju Bersama adalah salah satu koperasi yang
                        mensejahterakan anggotanya dengan menyediakan simpanan
                        dan pinjaman dalam jangka waktu panjang serta bunga yang
                        rendah.
                    </p>
                </div>
            </div>
            <div class="w-4/12 flex items-center justify-center">
                <svg
                    ...
                    <path
                        ...
                        transform="translate(-218.47153 -221)"
                        :fill="theme?.name == 'dark' ? '#63E2B7' : '#18A058'" />
                    <path
